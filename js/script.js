// I am getting errors :Uncaught TypeError: Cannot read property 'value' of null at HTMLTextAreaElement.myFunction
document.getElementById('bio').addEventListener("keyup", myFunction);

function myFunction(inID, outID) {
  var x = document.getElementById(inID).value;
  document.getElementById(outID).innerHTML = x
}
myFunction('bio', 'describeYourself')
